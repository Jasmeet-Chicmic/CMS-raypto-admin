...
const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div className="bg-bgwhite px-6 py-5 rounded-b-[20px] flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0 border-t border-[#f4f7fe] dark:bg-darkbgprimary dark:border-darkbordercolor1">
      <div className="flex items-center space-x-6">
        {/* Page size selector */}
        <div className="flex items-center space-x-3">
          <label
            htmlFor="pageSize"
            className="text-sm font-semibold text-sidebartext dark:text-gray-400"
          >
            Show
          </label>
          <div className="relative">
            ...
            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-textprimary dark:text-gray-400">
              <svg
        ...
        {totalItems === 0 ? (
          ...
          <p className="text-[0.875rem] text-sidebartext dark:text-gray-400">
            Showing{" "}
            <span className="font-bold text-sidebartext dark:text-gray-200">
      ...
      {totalPages > 0 && (
        <div className="flex items-center space-x-4 lg:flex-row gap-4 flex-col w-full lg:w-auto">
          ...
          {/* Jump to page */}
          <div className="flex items-center space-x-2 bg-gray-50 dark:bg-darkbgprimary p-1 rounded-[10px] border border-gray-100 dark:border-gray-700">
            <input
              type="number"
              min={1}
              max={totalPages}
              className="w-16 bg-transparent border-none px-2 py-1 text-sm font-bold text-textprimary dark:text-gray-200 outline-none placeholder:font-medium placeholder:text-gray-400"
              placeholder="Page"
              value={inputPage}

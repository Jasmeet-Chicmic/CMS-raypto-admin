...
export default function ComparisonCard({
  ...
  return (
    <div className="rounded-[5px] shadow-customsm bg-bgwhite p-[25px] w-full max-w-sm dark:bg-[#111827]">
            ...
            {i % 2 === 0 ? (
              <div key={`vs_${i + 1}`}>
                <div className="flex flex-col items-center justify-center h-32 gap-[3px]">
                  ...
                  <div className="rounded-full bg-gray-100 text-muted text-content w-[28px] h-[28px] text-center flex justify-center items-center dark:bg-darkbgprimary dark:text-gray-400">
                    VS
                  </div>
                  <div className="w-px h-6 bg-gray-300"></div>
                </div>

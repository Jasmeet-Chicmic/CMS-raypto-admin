...
const CustomModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bgbgwhite/10 backdrop-blur-sm dark:bg-[#111827]/50">
      <CheckClickOutside
        onClick={onClose}
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 text-gray-400 hover:text-gray-600 text-lg dark:text-sidebartext"
            aria-label="Close"
          >
            ✕
          </button>

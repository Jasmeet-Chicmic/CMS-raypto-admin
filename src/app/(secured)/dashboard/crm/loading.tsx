      ...
      <div className="p-0 mt-[20px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 max-h-fit">
          ...
          {Array.from(new Array(2)).map((_, id) => (
            <div
              key={`${baseId}-order-${id}`}
              className="bg-bgwhite shadow-customsm rounded-[5px] py-[25px] px-[20px] w-full dark:bg-[#111827]"
            >
          ...
          {Array.from(new Array(2)).map((_, id) => (
            <div
              ...
              className="bg-bgwhite rounded-xl shadow-sm p-4 flex flex-col items-start dark:bg-[#111827]"
            >
          ...
          <div className="col-span-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-[10px]">
            ...
            {/* Sales (Radar/Chart) */}
            <div className="bg-bgwhite shadow-customsm rounded-[5px] p-[25px] w-full dark:bg-[#111827]">
              <div className="mb-[10px]">
                <Skeleton className="h-6 w-24 mb-2" />
                <Skeleton className="h-4 w-16" />
              </div>

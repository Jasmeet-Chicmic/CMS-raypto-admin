...
export default function PaymentMethods({ cards, id }: Props) {
  ...
  return (
    <>
          ...
          {cards.map((card) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div>
                  <div className="flex items-center gap-2">
                    <p className="font-medium text-gray-800 dark:text-[#CCCFD1]">
                      {card.cardHolderName}
                    </p>
                  </div>
                  <p className="text-gray-600 text-sm tracking-widest dark:text-[#CCCFD1]">
              ...
              <div className="text-right space-y-1">
                ...
                <p className="text-[0.875rem] text-[#CCCFD1] dark:text-[#CCCFD1]">
      ...
      >
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-[#CCCFD1]">
            Add New Card
          </h2>

...
const NotificationsLoading = () => {
  ...
  return (
    <div className="bg-bgwhite rounded-lg border border-gray-200 p-6 space-y-6 animate-pulse dark:bg-darkbgprimary dark:border-darkbordercolor1">
      {/* Header */}
      <div>
      ...
      {/* Table Header */}
      <div className="grid grid-cols-4 gap-4 py-3 border-b border-gray-200 dark:bg-darkbgprimary dark:border-darkbordercolor1">

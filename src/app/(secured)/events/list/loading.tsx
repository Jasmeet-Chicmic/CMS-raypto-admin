          ...
          <table className="min-w-full divide-y">
            <thead className="bg-white dark:bg-gray-800">
              <tr>
                ...
                {/* Event Title, Created By, Type, Event Date/Time, Status, Trust Level, RSVP Count, Reports, Actions */}
                {[
                  "Event Title",
                  "Created By",
                  "Type",
                  ...
                  <th key={`${baseId}-header-${i}`} className="px-4 py-3">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              {Array.from(new Array(8)).map((_, rowIdx) => (
                <tr key={`${baseId}-row-${rowIdx}`}>
                  {/* Checkbox */}

      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-[#C4FF0E] text-[#000000] rounded-lg hover:bg-purple-700 transition-colors dark:bg-[#C4FF0E] dark:text-[#CCCFD1]"
          >
            <Plus size={18} />

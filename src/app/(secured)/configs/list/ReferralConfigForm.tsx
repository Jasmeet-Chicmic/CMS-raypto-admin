    ...
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="p-8 lg:p-10">
          ...
          {/* Referral Time Limit */}
          <div className="mb-8 p-6 bg-white dark:bg-[#111827] rounded-[10px] shadow-[0_0_10px_0_rgba(0,0,0,0.025)] border border-gray-100 dark:border-[#1A1A1A] transition-all duration-300">
            <div className="flex items-center gap-4 mb-4 pb-4 border-b border-gray-100 dark:border-[#1A1A1A]">
              <div className="p-3 bg-[#F4F7FE] dark:bg-[#C4FF0E] rounded-2xl">
                <Clock className="w-6 h-6 text-[#4F46E5] dark:text-[#000000]" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="group">
                {isEditing ? (
                  ...
                  <div className="p-6 bg-[#F4F7FE] dark:bg-[#1A1A1A]/40 rounded-[10px] border border-transparent hover:border-purple-200 dark:hover:border-purple-900/50 transition-all duration-300">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="p-3 bg-white dark:bg-[#C4FF0E] rounded-xl shadow-sm group-hover:scale-110 transition-transform duration-300">
                        <Clock className="w-5 h-5 text-[#4F46E5] dark:text-[#CCCFD1]" />
                      </div>
                  ...
                  <div className="group">
                    {isEditing ? (
                      ...
                      <div className="p-6 bg-[#F4F7FE] dark:bg-[#1A1A1A]/40 rounded-[10px] h-full border border-transparent hover:border-purple-200 dark:hover:border-purple-900/50 transition-all duration-300">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="p-3 bg-white dark:bg-[#C4FF0E] rounded-xl shadow-sm group-hover:scale-110 transition-transform duration-300">
                            <Target className="w-5 h-5 text-[#4F46E5] dark:text-[#CCCFD1]" />
                          </div>
                          <span className="text-[1.75rem] font-bold text-[#1B2559] dark:text-[#CCCFD1] leading-none">
                            {referralRewardConfig[
                              index
                  ...
                  <div className="group">
                    {isEditing ? (
                      ...
                      <div className="p-6 bg-[#F4F7FE] dark:bg-[#1A1A1A]/40 rounded-[10px] h-full border border-transparent hover:border-purple-200 dark:hover:border-purple-900/50 transition-all duration-300">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="p-3 bg-white dark:bg-[#C4FF0E] rounded-xl shadow-sm group-hover:scale-110 transition-transform duration-300">
                            <Banknote className="w-5 h-5 text-[#4F46E5] dark:text-[#CCCFD1]" />
                          </div>
                          <span className="text-[1.75rem] font-bold text-[#1B2559] dark:text-[#CCCFD1] leading-none">
                            {referralRewardConfig[
                              index
